...
- C помощью terraform развернул в YC новую виртуальную машину. Установил и настроил на ней докер, докер компоуз
- Развернул собственный сервер гитлаб в докер компоузе
- В гитлаб создал группу и проект
- Настроил первый пайплан с помощью .gitlab-ci.yml
- Чтобы пайплайн сам запускался зарегистрировал гитлаб раннер на сервере, где развернут гитлаб сервер
- Добивил исходный код реддит в свой репозиторий
- Добавил тесты в свой репозиторий, добавил их выполнение в ,gitlab-ci.yml
- Добавил несколько окружений
- Добавил условия запуска пайплайнов по тегам
- Добавил динамическое окружение
